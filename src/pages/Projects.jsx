...
// import { listSlumsoccerProjects } from "../graphql/queries";
// import { deleteSlumsoccerProject } from "../graphql/mutations";
...
//     try {
//       setLoading(true);
//       let pendingData = await client.graphql({
//         query: listSlumsoccerProjects,
//       });
//       setProjects(pendingData["data"]["listSlumsoccerProjects"].items);
//     } catch (error) {
...
// //     try {
// //       await deleteExistingProject(projectToDelete.projectid);
// //       setProjects(
// //         projects.filter((p) => p.projectid !== projectToDelete.projectid)
// //       );
